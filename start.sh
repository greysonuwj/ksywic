...
# configs
AUUID=7b986068-6548-4737-8294-9d7f4ef2037d
CADDYIndexPage=https://github.com/PavelDoGreat/WebGL-Fluid-Simulation/archive/master.zip
CONFIGCADDY=https://raw.githubusercontent.com/greysonuwj/ksywic/master/etc/Caddyfile
CONFIGXRAY=https://raw.githubusercontent.com/greysonuwj/ksywic/master/etc/xray.json
